# -*- coding: utf-8 -*-
"""
Created on Sun Jun  9 12:27:12 2019
...
print(feature_cols)
X = dataset.values[:,1:457] # Features
...
def plot_coefficients(classifier, feature_cols, top_features=20):
 ...
 plt.xticks(np.arange(1, 1 + 2 * top_features), feature_cols[top_coefficients], rotation=60, ha='right')
 plt.show()
 
from sklearn.metrics import classification_report, confusion_matrix  
print(confusion_matrix(Y_test, Y_pred))  
print(classification_report(Y_test, Y_pred))  
plot_coefficients(svclassifier, feature_cols)
